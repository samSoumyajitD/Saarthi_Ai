    ...
    <div className='welcomePage'>
      ...
      <section className="career-herofc">
        <div className="contentfc">
          <p className="empower-textfc">Academic Growth</p>
          <h1 className="titlewc">Unlock Your Career Potential with Our Services</h1>
          <p className="desctfc">  Our innovative services are designed to enhance your learning experience. From personalized plans to efficient AI assistance, we cater to all your academic needs.
          </p>
